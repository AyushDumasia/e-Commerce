...
function Hero() {
    return (
        <div className="relative h-screen px-[100px] sm:h-[80%] bg-slate-200">
            <div className="absolute inset-0 w-full h-full overflow-hidden xl:block sm:hidden">
                <svg
            ...
            <div className="relative flex items-center justify-evenly flex-col lg:flex-row w-full max-w-7xl mx-auto z-10 px-4 sm:px-6 lg:px-8  sm:h-[80%]">
                ...
                {/* Conditionally render the image for non-mobile devices */}
                <div className="w-full lg:w-1/2 mt-4 lg:mt-0 flex justify-center lg:justify-end xl:block sm:hidden">
                    <img
